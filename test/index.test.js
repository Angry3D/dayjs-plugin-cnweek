...
describe('get cnWeek', () => {
  ...
  test.each([
    ...
    ['2012-12-31', { week: 54, start: '2012-12-31', end: '2012-12-31' }],
...
describe('set cnWeek', () => {
  ...
  test.each([
    ...
    ['2024-06-12', 100000, 3909, 24],
    ['2024-06-12', -100000, 138, 28]
  ])(
  ...
  test.each([
    ['2024-02-29', 100000, '3909-06-13'],
    ['2024-02-29', -100000, '0138-07-11']
  ])(
    'keeps leap-day year shifting behavior for %s week %s',
    (ymd, week, expected) => {
      expect(transform(ymd, week)).toBe(expected)
    }
  )
