...
describe('get cnWeek', () => {
  ...
  test.each([
    [
      '2023-01-01',
      { week: 1, start: '2023-01-01', end: '2023-01-01' }
    ],
    [
      '2023-01-02',
      { week: 2, start: '2023-01-02', end: '2023-01-08' }
    ],
    [
      '2023-01-08',
      { week: 2, start: '2023-01-02', end: '2023-01-08' }
    ...
    [
      '2023-01-12',
      { week: 3, start: '2023-01-09', end: '2023-01-15' }
    ],
    [
      '2021-01-01',
      { week: 1, start: '2021-01-01', end: '2021-01-03' }
    ],
    [
      '2022-01-01',
      { week: 1, start: '2022-01-01', end: '2022-01-02' }
    ],
    [
      '2024-01-01',
      { week: 1, start: '2024-01-01', end: '2024-01-07' }
    ],
    [
      '2024-02-29',
      { week: 9, start: '2024-02-26', end: '2024-03-03' }
    ],
    [
      '2020-12-31',
      { week: 53, start: '2020-12-28', end: '2020-12-31' }
    ],
    [
      '2024-12-31',
      { week: 53, start: '2024-12-30', end: '2024-12-31' }
    ],
    [
      '2018-12-31',
      { week: 53, start: '2018-12-31', end: '2018-12-31' }
    ]
  ])('%s', (ymd, expected) => {
